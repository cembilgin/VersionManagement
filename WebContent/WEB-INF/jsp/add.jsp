...
<div class="navbar navbar-inverse "
       ...
       <form:form method="get" modelAttribute="surum"
             action="/VersionManagement/addSurum">
             <table style="margin-left: 20px; margin-top: 20px;" width="563" border="0">
                    <tbody>
                                        <tr>
                                  <td width="163" height="40"><strong>Version </strong></td>
                                  <td width="81"><input type="text" class="form-control" style="width:150px;height:30px;"
                           ...
                           <tr>
                                  <td width="163" height="40"><strong>Version Type </strong></td>
						...
						<c:forEach var="listValue" items="${surumlist}">
                           ...
                           <tr>
                                  <td width="163" height="40"><strong>Date of Analysis
                                               </strong></td>
                                  <td width="81"><input type="text" class="form-control"
                                        name="analizTarihi" id="analizTarihi" style="background-color:#fff; width:150px;height:30px;" readonly></td>
                                  <td width="61">&nbsp;</td>
                           </tr>
                           <tr>
                                  <td width="163" height="40"><strong>Date of Developing </strong></td>
                                  <td width="81"><input type="text" class="form-control"
                                        name="gelistirmeTarihi" id="gelistirmeTarihi" style="background-color:#fff; width:150px;height:30px;" readonly></td>
                                  <td width="61">&nbsp;</td>
                           </tr>
                           <tr>
                                  <td width="163" height="40"><strong>Date of Testing</strong></td>
                                  <td width="81"><input type="text" class="form-control"
                                        name="testeTeslimTarihi" id="testeTeslimTarihi"style="background-color:#fff; width:150px;height:30px;" readonly></td>
                                  <td width="61">&nbsp;</td>
                           </tr>
                           <tr>
                                  <td width="163" height="40"><strong>Date of Go-live
                                               </strong></td>
                                  <td width="81"><input type="text" class="form-control"
                                        name="canliAlimTarihi" id="canliAlimTarihi" style="background-color:#fff; width:150px;height:30px;" readonly ></td>
                                  <td width="61">&nbsp;</td>
                           </tr>
                        
                           <tr>
                                  <td width="163" height="40"><strong>Status </strong></td>
						...
						<c:forEach var="listValue" items="${surumlist2}">
                           ...
                           <tr>
                                  <td colspan="2"><input class="btn btn-danger btn-md" style="margin-top:30px;"
